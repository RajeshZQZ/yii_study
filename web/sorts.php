...
$a = array_rand(range(1,10000), 300); //生成3000个元素的随机数组
shuffle($a); //打乱数组的顺序

$array_sort = array('BubbleSort'=>'冒泡排序','selectSort'=>'选择排序','insertSort'=>'插入排序','quickSort'=>'快速排序','sort'=>'sort排序','mergeSort'=>'归并排序');

foreach ($array_sort as $key => $value) { 
    $time_s = microtime(true);
    test($key,$a);
    $time_e = microtime(true);
    echo $value."用时：".(($time_e-$time_s)*1000).'ms'."</br>";
}
